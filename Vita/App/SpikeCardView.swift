...
/// Reaches the hosting `UISheetPresentationController`, force-enables
/// `prefersScrollingExpandsWhenScrolledToEdge`, and reports what it found so
/// the spike probe can display it.
